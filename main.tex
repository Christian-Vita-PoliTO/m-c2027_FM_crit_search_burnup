...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/critical_drum_angle_over_the_cycle_with_maps.pdf}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.80\textwidth]{figures/excess_reactivity_with_the_drums_fully_extracted.pdf}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.60\textwidth]{figures/independence_hypothesis_structural_error_measured.pdf}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.54\textwidth]{figures/interpolation_error_vs_snapshot_grid_density.pdf}
