...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.90\textwidth]{figures/critical_drum_angle_over_the_cycle_with_maps.pdf}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/excess_reactivity_with_the_drums_fully_extracted.pdf}
...
The residual of the method is the $(T,\theta)$ interpolation of the original database, not the burnup correction. Replacing the power-to-temperature correlation of Eq.~\eqref{eq:t} with a thermal response from a conduction solver is the natural next step, and the interface of the workflow already allows it. The construction does not depend on the power level: the temperature axis of the database carries it, and the same snapshot database serves the search at any power.
